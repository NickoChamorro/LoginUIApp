...
const LoginScreen = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            {/* <View style={{width: 100, height: 100, backgroundColor: 'purple', position: 'absolute', borderRadius: 100 }}></View>
                ...
                <BlurView intensity={100} style={{borderRadius: 10}}>
                    <View style={styles.login}>
                        ...
                        <View>
                            ...
                            <TextInput onChangeText={(text) => setEmail(text)} style={styles.input} placeholder="nombre@correo.com" />
                        </View>
                        <View>
